...
import { View, Text, Image, StyleSheet, Button, Alert, Animated, Easing } from 'react-native';
...
const levels = [
  {
    ...
    steps: [
      ...
      { id: '2', image: require('./assets/escovarDentes.jpg'), text: 'Escovar os dentes' },
      { id: '3', image: require('./assets/colocarRoupa.jpg'), text: 'Se vestir' },
      { id: '4', image: require('./assets/colegio.png'), text: 'Ir para o colégio' },
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      { id: '2', image: require('./assets/escovarDentes.jpg'), text: 'Escovar os dentes' },
      { id: '3', image: require('./assets/roupaDormir.jpg'), text: 'Colocar pijama' },
    ...
    <GestureHandlerRootView style={{ flex: 1 }}>
      <View style={styles.container}>
        ...
        {!(currentLevel === levels.length - 1 && isOrderCorrect) && (
          <Button
            title="Verificar Ordem"
            onPress={checkOrder}
          />
        )}
        {isOrderCorrect && (
          <Animated.View style={[styles.confetti, { transform: [{ translateY: confettiAnimation }] }]}>
            <Text style={styles.correctText}>✅ A ordem está correta!</Text>
          </Animated.View>
        )}
        {!isOrderCorrect && <Text style={styles.incorrectText}>❌ A ordem está incorreta.</Text>}
        {currentLevel === levels.length - 1 && isOrderCorrect && (
